...
namespace Visitor_Security_Clearance_System.Service
{
    public class OfficeService : IOfficeService
    {
        ...
        public async Task<OfficeDTO> RegisterOffice(OfficeDTO officeDTO)
        {
            ...
            office.Intialize(true, Credentials.OfficeDocumentType, "Sudh", "Sudh");
        ...
        public async Task<OfficeDTO> UpdateOffice(OfficeDTO officeDTO)
        {
            ...
            existingOffice.Intialize(false, Credentials.OfficeDocumentType, "Sudh", "Sudh");
        ...
        {            
            ...
            office.Intialize(false, Credentials.OfficeDocumentType, "Sudh", "Sudh");
            office.Archived = true;
